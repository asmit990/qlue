      ...
      <main className="relative z-10 flex-1 flex flex-col md:flex-row">
        ...
        <section className="flex-1 bg-white md:bg-transparent flex flex-col items-center justify-center p-6 sm:p-20 relative">
          ...
          >
            ...
            <div className="mt-12 flex justify-center text-[10px] text-gray-400 uppercase tracking-widest">
              <a href="/register" className="hover:text-black transition-colors underline underline-offset-4">
